...
GEMINI_API_KEYS = [
"AIzaSyBxXG54stiUZI09SWayH-H0wfGKGgK9b5U",
"AIzaSyAxAjHztQXy5IKHTy6ikVC7R3kK6pLviog",
"AIzaSyBPNyh9KsOPukg5krFHyBd21tBzrO775Es",
"AIzaSyDe7g6TAOVeZYovIA1mMAu-K8QsL0K1a9Q",
"AIzaSyB18ACKa_jQmf0jLCPjhHkP1kct6kxskhA",
"AIzaSyAopPL9od66YhH0F7_eLOJIzRFrKILdQAQ",
"AIzaSyAazLKitOAzdao9zHLSP_AUYo3EDZjql6Y",
"AIzaSyCdr1EsoHYtlYitlyY5n9H9HFmFelKVJ1o",
"AIzaSyDm8cA80emVmtzQAzhc9tN0lbQRQaMIEcg",
"AIzaSyAWxEqdSk0q8JtGEOjfbWkGuxtcpoH_jy0",
"AIzaSyBGgjwtUo6100Rg4sckYL1boy-2DX4mqL8",
"AIzaSyAp9jpcc3FM0qNP5WLEW4yLj51oHWlb1zM",
"AIzaSyCs-8Wex_ngQw3Co0nuvJ3N_qgqbwTQG4M",
"AIzaSyCppeJC3XTOCc1GZdbR8W2FXiHnFVQDHBk",
"AIzaSyCIAyb0PXc49p7xi80eTM68REdikkTNnXM",
"AIzaSyDPwb4dtDZPvkBUCiLjPZ_y5BhjZw90kgs",
"AIzaSyD7HnePkk1O6pHQk7jCLCrQJ0TEcUzgjzg",
"AIzaSyCTqVglbFCuGIeOuxR5N972j7tEIqsPORg",
"AIzaSyCFoHY2zxxkAlpAdQxf-YI7hzhONfjHOao",
"AIzaSyBrad4RQvXAtvOHGPfeSEax82SVZG46FcY",
"AIzaSyBoT9pc8fWTqqnJp7SSLRRwo3N8Sy8UvvE",
"AIzaSyDLeGeaUhnpLEleLDsjn-3RHqAQre_B92M",
"AIzaSyBvcNLdsAh5lPWtJ-0lH2lmtWCyTPJ-GsE",
"AIzaSyBq2EzJicOpa2cU_-gOf73WjaSafdgeiOk",
"AIzaSyCSrnc7yQ0YHuwltU1FQyZbsyQgBDHjTJk"
]
...
class EnhancedViralThreadGenerator:
    ...
    def generate_image(self, prompt):
        ...
        try:
            ...
            # Import directly like in your example 
            from google import genai
            from google.genai import types
            # Initialize the client correctly
            
            client = genai.Client(api_key="AIzaSyDlONrBUFjXGjRJ9Q2EcXaANSszSB6wwyU")
            ...
            for part in response.candidates[0].content.parts:
                if part.inline_data is not None:
                    ...
                    # Save to BytesIO to convert to base64
                    buffered = BytesIO()
    ...
    def schedule_in_calendar(self, email, schedule_data, topic):
        """Schedule tweets in Google Calendar using Composio"""
        try:
            # Import directly like in your example
            from google import genai
            from google.genai import types
            ...
            # For Composio, ensure you have the right import
            from composio_gemini import Action, ComposioToolSet, App
            ...
            # Create one calendar entry for each scheduled tweet
            results = []
            for item in schedule_data:
                tweet_num = item["tweet_number"]
                dt = item["datetime"]
                
                # Format the message for Composio
                message = f"""
                Create a Google Calendar event with these details:
                Title: "Post Tweet #{tweet_num} for '{topic}' Thread"
                Description: "Scheduled tweet for viral thread campaign about {topic}. Check your Twitter dashboard."
                Start time: {dt.isoformat()}
                End time: {(dt + timedelta(minutes=15)).isoformat()}
                ...
                results.append({
                    "tweet_number": tweet_num,
                    "scheduled_time": item["scheduled_time"],
                    "composio_response": response.text
                })
    ...
    def generate_thread(self, topic, thread_count=5, email=None):
        ...
        try:
            ...
            # Schedule in calendar if email provided
            calendar_results = []
            if email:
                calendar_results = self.schedule_in_calendar(email, schedule, topic)
